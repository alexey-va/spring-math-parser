...
public class BasicArithmeticProvider extends ArithmeticProvider {
    ...
    public List<Token> sanitize(List<Token> tokens) throws CannotParseExpressionException {
        ...
        for (Token t : tokens) {
            ...
            if (t.getString().equals("+") || t.getString().equals("-"))
                previousIsValue = false;
            else previousIsValue = true;
    ...
    private void init() {
         ...
         */
        addFunction(
                new BinaryOperator.Builder().name("+").priority(1).computable(args -> {
        ...
        addFunction(
                new BinaryOperator.Builder().name("*").priority(2).aliases(Set.of("×")).computable(args -> {
                    if (args.size() != 2) throw new CannotParseExpressionException();
                    return new Token(format(args.get(0).toDouble() * args.get(1).toDouble()), Token.Type.VALUE);
                }).build()
        );
         ...
         */
        addFunction(
                new UnaryOperator.Builder().name("!").priority(100).postfix(true).computable(args -> {
        ...
        addFunction(
                new BinaryOperator.Builder().name("%").priority(3).computable(args -> {
                    if (args.size() != 2) throw new CannotParseExpressionException();
                    return new Token(format((args.get(0).toDouble() % args.get(1).toDouble())), Token.Type.VALUE);
                }).build()
        );
        ...
        addFunction(
                new BinaryOperator.Builder().name("^").aliases(Set.of("**")).priority(4).computable(args -> {
                    if (args.size() != 2) throw new CannotParseExpressionException();
                    return new Token(format(Math.pow(
                            args.get(0).toDouble(), args.get(1).toDouble()
                            )), Token.Type.VALUE);
                }).build()
        );
         ...
         */
        addFunction(
                new ArgsFunction.Builder().name("sin").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("cos").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("tan").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("sind").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("cosd").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("tand").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("sinh").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("cosh").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("tanh").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("asin").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("acos").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("atan").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
         ...
         */
        addFunction(
                new ArgsFunction.Builder().name("max").computable(args -> {
        ...
        addFunction(
                new ArgsFunction.Builder().name("min").computable(args -> {
                    if (args.isEmpty()) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("rand").computable(args -> {
                    //if (args.isEmpty()) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("ceil").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("floor").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("ln").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
        ...
        addFunction(
                new ArgsFunction.Builder().name("log10").computable(args -> {
                    if (args.size() != 1) throw new CannotParseExpressionException();
